...
const BeckPermisos: React.FC = () => {
  ...
  const selectedRolLabel = selectedRol
    ? (ROLES_BECK.find((r) => r.value === selectedRol)?.label ?? selectedRol)
    : "";
          ...
          excepcionUsuario ? (
            <div>
              ...
              <div className="mt-0.5 text-xs font-normal text-slate-500">
                ...
                {" — "}
                <Tag
                  color={ROL_TAG_COLOR[excepcionUsuario.rol]}
                  style={{ marginInlineEnd: 0 }}
                >
                  {ROLES_BECK.find((r) => r.value === excepcionUsuario.rol)?.label ??
