...
const ESTADOS: Array<{ label: string; value: FirematCotizacionEstado; color: string }> = [
  ...
  { label: "Rechazada", value: "RECHAZADA", color: "red" },
  { label: "Vencida", value: "VENCIDA", color: "gold" },
];
...
const getEstadoColors = (estado: string) => {
  ...
  if (estado === "ACEPTADA") return { backgroundColor: "#dcfce7", color: "#166534" };
  if (estado === "RECHAZADA") return { backgroundColor: "#fee2e2", color: "#b91c1c" };
  if (estado === "VENCIDA") return { backgroundColor: "#ffedd5", color: "#9a3412" };
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
        ...
        <ResumenCard label="Aceptadas" value={resumen.aceptadas} />
